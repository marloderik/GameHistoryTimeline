 'type': ' Space Shotter', // game or console
        ...
        'resume': [
            ' Spacewar is one of the earliest digital computer video games , it is a two-player game , with each player taking control of a  ',
            ' starship and attempting to destroy the other. A star in the center of the screen pulls on both ships and requires maneuvering  ',
            ' to avoid falling into it.In an emergency,a player can enter hyperspace to return at a random location on the screen, but only .'
            'at the risk of exploding if it is exploited.'
            'After Alan Kotok obtained some sine and cosine routines from DEC, Russell began,coding, and, by February 1962, produced its first version.'
            'It took about 200 hours of work to create the initial version.The additional features were developed by Dan Edwards,Peter Samson, and Graetz.'
        ].join(''),
        'full_text': [
